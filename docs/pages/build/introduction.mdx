      ...
      <View style={styles.modalOverlay}>
        <Animated.View entering={ZoomIn.duration(350)} style={styles.councilCard}>
          ...
          <Text style={styles.councilDescription}>
            You have reached Question {currentQuestionNumber}. The Council offers guaranteed Pearls to walk away, or you can risk your run for higher ranks.
          </Text>
          
          <Text style={styles.offerAmount}>{offeredPearls} PEARLS</Text>
          
          <TouchableOpacity activeOpacity={0.8} style={styles.acceptButton} onPress={handleAccept}>
            <Text style={styles.acceptButtonText}>ACCEPT & CASH OUT</Text>
          </TouchableOpacity>
          
          <TouchableOpacity activeOpacity={0.7} style={styles.declineButton} onPress={handleDecline}>
...
const styles = StyleSheet.create({
  modalOverlay: {
    flex: 1,
    backgroundColor: 'rgba(8, 10, 21, 0.92)',
